...
export default function Jeans() {
  ...
  const handleAddToCart = () => {
    ...
    const quantity = 1;
    addToCart({ name: 'Mast & Harbour Men Slim Fit Jeans', price: '₹949.99', size, image: jeans }, quantity);
  };
      ...
      <main className="main-content">
        <section id="mens-section" className="mens-section" style={{ display: 'flex', alignItems: 'flex-start', gap: '2rem', padding: '2rem' }}>
          <div className="product-image-container" style={{ flex: '1', maxWidth: '50%'}}>
            <img src={jeans} alt="Jeans" className="product-image" style={{ height: '60%', width: '60%', objectFit: 'cover' }} />
          </div>
          <div className="product-details" style={{ flex: '1', maxWidth: '50%', textAlign: 'center' }}>
            <h1 style={{ textAlign: 'center', fontFamily: "'Playfair Display', serif", color: '#ffd700', textShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }}>Mast & Harbour Men Slim Fit Jeans</h1>
            ...
            <h3 style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.9)', fontWeight: '300' }}>Blue slim fit jeans,<br />
                 has a button closure, 5 pockets,<br />
                 straight hem</h3>
            ...
            <h3 className="product-title" style={{ textAlign: 'center', color: '#e8e8e8', fontWeight: '600' }}>Jeans</h3>
            <p className="product-price" style={{ textAlign: 'center', color: '#ffd700', fontWeight: '700' }}>price - ₹949.99</p>
          </div>
        </section>
      </main>
      </div>
