...
export default function Casualwear() {
  ...
  const handleAddToCart = () => {
    ...
    const handleAddToWishlist = () => {
      ...
      addToWishlist({ name: 'Boys Denim Jacket', price: '₹349.99', size, image: casual });
    };
      ...
      <main className="main-content">
        <section id="mens-section" className="mens-section" style={{ display: 'flex', alignItems: 'flex-start', gap: '2rem', padding: '2rem' }}>
          <div className="product-image-container" style={{ flex: '1', maxWidth: '50%'}}>
            <img src={casual} alt="Casual" className="product-image" style={{ height: '60%', width: '60%', objectFit: 'cover' }} />
          </div>
          <div className="product-details" style={{ flex: '1', maxWidth: '50%', textAlign: 'center' }}>
            <h1 style={{ textAlign: 'center', fontFamily: "'Playfair Display', serif", color: '#ffd700', textShadow: '0 0 20px rgba(255, 215, 0, 0.5)' }}>Mast & Harbour Men Cotton Striped Casual Shirt</h1>
            ...
            <h3 style={{ textAlign: 'center', color: 'rgba(232, 232, 232, 0.9)', fontWeight: '300' }}>White and Green vertical stripes striped opaque Casual shirt,<br />
               has a button-down collar, button placket,<br />
               1 patch pocket, long regular sleeves, curved hem</h3>
            ...
            <h3 className="product-title" style={{ textAlign: 'center', color: '#e8e8e8', fontWeight: '600' }}>Casual Wear</h3>
